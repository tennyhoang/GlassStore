                ...
                <div key={order.orderId} className={styles.orderCard}>
                  ...
                  <div className={styles.orderHeader}
                    ...
                    <div className={styles.orderRight}>
                      <span className={styles.orderTotal}>{fmtCurrency(order.finalAmount)}</span>
                      {isExpanded
                      ...
                      <div className={styles.infoGrid}>
                        ...
                        {order.discountCode && (
                          <div className={styles.infoItem}>
                            ...
                            <p>{order.discountCode} (-{fmtCurrency(order.discountAmount)})</p>
                          </div>
                        )}
                        {order.note && (
                          <div className={styles.infoItem}>
...
<div class="section">
  ...
  <table>
    ...
    <tbody>
      ...
      ${order.discountAmount ? `<tr><td colspan="3" style="text-align:right;color:#2e7d32">Giảm giá (${order.discountCode}):</td><td style="color:#2e7d32">-${fmtCurrency(order.discountAmount)}</td></tr>` : ''}
      <tr class="total-row"><td colspan="3">TỔNG CỘNG</td><td>${fmtCurrency(order.finalAmount)}</td></tr>
    </tbody>
  </table>
</div>
