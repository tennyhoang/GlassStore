        ...
        <div className={styles.layout}>
          ...
          <div className={styles.summaryCard}>
            ...
            <div className={styles.sumRow}>
              <span>Giá</span><span>{fmtCurrency(product?.price)}</span>
            </div>
            <div className={styles.sumRow}>
            ...
            <div className={styles.sumRow}>
              <span>Tổng tiền</span>
              <span style={{fontFamily:'var(--font-display)',fontSize:'1.1rem'}}>{fmtCurrency(totalAmount)}</span>
            </div>
            <div className={styles.depositRow}>
              <span>Đặt cọc ngay (30%)</span>
              <span style={{color:'#e65100',fontWeight:700}}>{fmtCurrency(depositAmount)}</span>
            </div>
            <div className={styles.depositNote}>
              Phần còn lại <strong>{fmtCurrency(totalAmount - depositAmount)}</strong> thanh toán khi nhận hàng
            </div>
